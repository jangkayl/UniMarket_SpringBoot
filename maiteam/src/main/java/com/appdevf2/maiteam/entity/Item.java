...
public class Item {
    ...
    @ManyToOne // STUDENT ||--o{ ITEM : "owns/sells"
    ...
    private Long itemPhotoId; // Assuming a photo ID reference
    ...
    private String transactionType; // e.g., "SALE", "RENTAL"

    @Column(name = "rental_fee")
    private Double rentalFee;

    // Storing duration as an integer for days or a specific end date
    ...
    // One Item can be referenced by many Messages
